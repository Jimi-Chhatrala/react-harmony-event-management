          ...
          ? data.map((element, index) => {
              return (
                <div
                  ...
                  onClick={
                    () => navigate(`/events/event/event-detail/${element._id}`)
                    // navigate("/events/event/event-detail", { state: element })
                  }
                >
                  ...
                  <div className={styles.event_text_2}>
                    ...
                    <p>
                      <BiRupee className={styles.gallery_text_icon} />
                      <span>{element.price} onwards</span>
                    </p>
                  </div>
                </div>
              );
